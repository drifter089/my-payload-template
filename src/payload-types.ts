...
export interface PageSection {
  component: 'carousel' | 'basic' | 'grid';
  cards: 'horizontalcards' | 'verticalcard' | 'upcomingevents' | 'pastevents' | 'platforms';
  limit: number;
  id?: string | null;
  blockName?: string | null;
  blockType: 'section';
...
export interface HomeSelect<T extends boolean = true> {
  ...
  layout?:
    | T
    | {
        Hero?: T | LandingHeroSelect<T>;
        section?: T | PageSectionSelect<T>;
        Social?:
          | T
          | {
              backgroundColor?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "PageSection_select".
 */
export interface PageSectionSelect<T extends boolean = true> {
  component?: T;
  cards?: T;
  limit?: T;
  id?: T;
